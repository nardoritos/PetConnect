<?php
	...
	$db = "db_petconnect"; //Nome do Banco de Dados onde estão as tabelas.
	$user = "petconnect"; //Nome do usuário para conectar ao Banco de Dados.
	$password = "21890"; //Senha do usuário para conectar ao Banco de Dados.
